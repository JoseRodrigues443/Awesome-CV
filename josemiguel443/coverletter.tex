...
\photo[circle,noedge,left]{./josemiguel443/profile}
\name{Miguel}{Rodrigues}
\position{Senior Software Engineer}

\address{Matosinhos, Porto, Portugal, 4460-170}

\mobile{(+351) 910 920 245}
\email{josemiguel443@gmail.com}
\homepage{joserodrigues443.github.io}
\github{JoseRodrigues443}
\linkedin{josé-rodrigues-165290110}
%\dateofbirth{January 1st, 1970}
% \gitlab{gitlab-id}
% \stackoverflow{SO-id}{SO-name}
\twitter{@JosRodr63795423}
% \skype{skype-id}
% \reddit{reddit-id}
% \medium{madium-id}
% \kaggle{kaggle-id}
...
\lettertitle{Job Application for Senior Software Engineer - Developer Experience}
